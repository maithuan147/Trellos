...
@section('content')
    ...
    <form method="POST" action="{{ route('checklist.update', $checklist) }}" class="mx-15 mt-20">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-9">
                    <div class="main-form bg-white pxy-15">
                        <div class="form-body row">
                            <div class="form-group col-md-12">
                                <label for="content" class="control-label col-md-2">{{ __('Content')}}<span style="color: red"> *</span></label>
                                <div class="col-md-10">
                                    <input class="form-control" id="content" data-counter="30" name="content" type="text" required value="{{ $checklist->content }}">
                                </div>
                            </div>
                            <div class="form-group col-md-12">
