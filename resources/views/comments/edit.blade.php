...
@section('content')
    ...
    <form method="POST" action="{{ route('comment.update', $comment) }}" class="mx-15 mt-20">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-9">
                    <div class="main-form bg-white pxy-15">
                        <div class="form-body row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" id="content" data-counter="30" name="content" type="text" required value="{{ $comment->content }}">
                                </div>
                            </div>
                            <div class="form-group col-md-12">
