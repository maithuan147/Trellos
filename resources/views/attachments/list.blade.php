    ...
    <div class="content-wrapper" style="min-height: calc(100vh - 105px);">
        ...
        <div class="row bg-white font-size-13 mx-15 py-10 mt-15 mb-3">
                ...
                <div class="col-sm-6 justify-content-end display-flex">
                    <a href="{{ route('attachments.create') }}" class="bg-36c6d3 px-10 mr-10 color-white"><i class="fa fa-plus"></i> Create</a>
            ...
            @foreach ($attachments as $attachment)
                <tr class="child">
                    ...
                    <td class="text-center vertical-align-middle"> 
                        <a href="{{ route('attachments.edit', $attachment) }}" class="btn btn-primary font-size-15"><i class="fa fa-edit"></i></a>
                        <form action="{{ route('attachments.destroy',$attachment) }}" method="post" class="display-inline-block">
                            @csrf
                            @method('DELETE')
