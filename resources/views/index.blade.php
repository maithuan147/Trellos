...
<div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <a href="{{ url('listtask') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <a href="{{ url('task') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <a href="{{ url('comment') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
          </div>
            ...
            <section class="col-lg-7 connectedSortable">
              ...
              <div class="box box-success">
                ...
                <div class="box-body chat" id="chat-box">
                  <!-- chat item -->
                  <div class="item">
                    <img src="{{ asset('img/user2.jpg') }}" alt="user image" class="online">
                  ...
                  <!-- chat item -->
                  <div class="item">
                    <img src="{{ asset('img/user2.jpg') }}" alt="user image" class="offline">
